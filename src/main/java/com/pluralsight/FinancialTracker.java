...
public class FinancialTracker {
        ...
        while (running) {
            ...
            switch (input) {
                ...
                case "4":
                    ...
                    // including the date, vendor, and amount for each transaction.
                    System.out.println("Transactions for prevous Year");
                    LocalDate previousYear = LocalDate.now().minusYears(1);

                    System.out.println("Previous Year: " + previousYear.getYear());
    ...
    private static void filterTransactionsByDate(LocalDate startDate, LocalDate endDate) {
        ...
        System.out.println("Your Transactions between" + " " + " :");
        boolean found = false;
        for (Transaction transaction: transactions) {
        ...
        if (!found) {
            System.out.println("No Transactions between" + startDate + " and " + endDate);
        }
    }
